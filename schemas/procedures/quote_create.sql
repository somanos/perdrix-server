...
BEGIN
  ...
  SELECT IFNULL(JSON_VALUE(_args, "$.ht"), 0) INTO _ht;
  SELECT IFNULL(JSON_VALUE(_args, "$.tva"), 0.20) INTO _tva;
  SELECT IFNULL(JSON_VALUE(_args, "$.ttc"), 0) INTO _ttc;
  SELECT IFNULL(JSON_VALUE(_args, "$.discount"), 0) INTO _discount;
