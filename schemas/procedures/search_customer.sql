     ...
     'customer' `type`,
      ...
      FROM customer c
        ...
        WHERE 
          ...
          IF(_firstname IS NULL, 1, c.firstname REGEXP _firstname) AND
        ...
        ORDER BY
        CASE WHEN LCASE(_order) = 'asc' THEN custName END ASC,
        CASE WHEN LCASE(_order) = 'desc' THEN custName END DESC
